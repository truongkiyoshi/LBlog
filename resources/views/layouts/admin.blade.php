...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{URL::asset('admin')}}" class="logo">
      ...
      <span class="logo-mini"><b>T</b>CT</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Admin</b>TCT</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  {{Auth::user()->name}} - <?php echo (Auth::user()->level == 1) ? "Admin" : "Member"?>
                </p>
              </li>
              <!-- Menu Footer-->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="{{URL::asset('admin/manage-user')}}">
          ...
          <ul class="treeview-menu">
            <li><a href="{{URL::asset('admin/manage-user/add')}}"><i class="fa fa-circle-o"></i> Add User</a></li>
            <li><a href="{{URL::asset('admin/manage-user')}}"><i class="fa fa-circle-o"></i> Manage User</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="{{URL::asset('admin/manage-post')}}">
          ...
          <ul class="treeview-menu">
            <li><a href="{{URL::asset('admin/manage-post/add')}}"><i class="fa fa-circle-o"></i> Add Post</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="{{URL::asset('/admin/')}}"><i class="fa fa-dashboard"></i> Home</a></li>
